        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-600">Manage email and document templates for communications</p>
                </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    <div class="p-2 rounded-lg ${template.type === 'email' ? 'bg-blue-100' : template.type === 'sms' ? 'bg-green-100' : 'bg-gray-100'} mr-3">
                                        ${template.type === 'email' ? 
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs px-2 py-1 rounded-full ${template.type === 'email' ? 'bg-blue-100 text-blue-800' : template.type === 'sms' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}">${template.type.toUpperCase()}</span>
                                    </div>
                                </div>
                            ...
                            <p class="text-gray-600 text-sm mb-4 line-clamp-3">${template.content.substring(0, 150)}${template.content.length > 150 ? '...' : ''}</p>
                            ...
                            <div class="mt-4 pt-4 border-t">
                                <button onclick="useTemplate(${template.id})" class="w-full bg-primary text-white py-2 px-4 rounded-md hover:bg-primary-dark text-sm">
                                    Use Template
                                </button>
                            </div>
                        </div>
